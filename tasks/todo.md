...
- [x] D1. workflow: H3 clips in reference mode, music step, assembly, podcast path (82 tests); split into workflow / steps / shared so the DevKit bundle stays Node-free
...
- [x] Whole project: `npx tsc --noEmit` 0 errors, `npm run lint` 0 errors, `npm test` 413 passing in 19 files, `npm run build` clean (20 routes)
